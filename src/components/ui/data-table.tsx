...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-zinc-50 dark:bg-zinc-900/50 [&_tr]:border-b",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-zinc-50/50 font-medium dark:bg-zinc-900/50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "data-[state=selected]:bg-[#2563EB]/5",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle font-medium text-zinc-500 dark:text-zinc-400",
